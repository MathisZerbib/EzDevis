...
<div class="wrap">
  <h1>EzDevis Admin</h1>
    ...
    <p> Voici votre shortcode à coller dans une de vos pages pour afficher le formulaire de devis <input type="text" name="shortcode" value="[ez_devis_form_shortcode]" style="width: 16%"></p>
</div> 
            ...
            <table class="uk-table uk-table-hover uk-table-striped" id="myTable2">
                ...
                foreach ($results as $result) {
                    ...
                    <tr id="row<?php echo $result->cli_id;?>">
                        ...
                        <td style="text-align: center; ">
                            <a href="#" id="delete_button_cli<?php echo $result->cli_id;?>" onclick="delete_row_cli('<?php echo $result->cli_id;?>');" class="button button-primary" >Supprimer</a>
                        </td>
                    </tr>
                <?php
                    $i++;
